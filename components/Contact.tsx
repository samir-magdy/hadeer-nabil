...
export default function Contact({ language }: { language: Language }) {
  ...
  return (
    <section
      id="contact"
      className="bg-warm-white py-20 md:py-28 lg:py-32 min-h-screen flex items-center"
    >
      <div className="max-w-4xl mx-auto px-6 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-8 md:mb-10 flex flex-col items-center gap-3 md:gap-4">
          <a
            dir="ltr"
            href={`mailto:${EMAIL}`}
            className="inline-flex items-center gap-2 cursor-pointer text-base md:text-xl text-text-mid underline underline-offset-4 decoration-border"
            data-arabic-ui={language === "ar" ? "true" : undefined}
          >
            {/* Mail Icon */}
            <svg
...
function WhatsAppIcon() {
  return <img src="/whatsapp-green.svg" alt="" className="w-6 sm:w-8" />;
}
