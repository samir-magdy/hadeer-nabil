      ...
      <nav className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-18">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-primary text-warm-white text-sm font-medium px-4 py-2 rounded-full hover:bg-primary/90 transition-colors duration-200 min-h-[44px]"
          >
            <WhatsAppIcon />
            WhatsApp
          </a>
      ...
      >
        <div className="px-4 py-4 flex flex-col gap-4">
          ...
          <a
            ...
            rel="noopener noreferrer"
            onClick={() => setMenuOpen(false)}
            className="inline-flex items-center justify-center gap-2 bg-primary text-warm-white text-sm font-medium px-4 py-3 rounded-full hover:bg-primary/90 transition-colors duration-200 min-h-[44px]"
          >
            <WhatsAppIcon />
            Message on WhatsApp
          </a>
